...
public class UserConverter {
    ...
    public UserDTO fromUserToDTO(User user) {
        ...
        userDTO.setMajorId(user.getMajorUserEntities() != null ? user.getMajorUserEntities().getId() : null);
        userDTO.setMajorName(user.getMajorUserEntities() != null ? user.getMajorUserEntities().getName() : null);
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
